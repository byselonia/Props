...
export default function PiratesPage() {
  ...
  const roster = [
    ...
    { id: 14, name: 'Joey Bart', position: 'Catcher', number: '14' },
    { id: 15, name: 'Adam Frazier', position: 'Infielder', number: '26' },
    { id: 16, name: 'Nick Gonzales', position: 'Infielder', number: '39' },
    { id: 17, name: "Ke'Bryan Hayes", position: 'Infielder', number: '13' },
    { id: 18, name: 'Spencer Horwitz', position: 'Infielder', number: '2' },
    { id: 19, name: 'Isiah Kiner-Falefa', position: 'Infielder', number: '7' },
    { id: 20, name: 'Endy Rodríguez', position: 'Infielder', number: '5' },
    { id: 21, name: 'Jared Triolo', position: 'Infielder', number: '19' },
    { id: 22, name: 'Alexander Canario', position: 'Outfielder', number: '29' },
    { id: 23, name: 'Oneil Cruz', position: 'Outfielder', number: '15' },
    { id: 24, name: 'Andrew McCutchen', position: 'Outfielder', number: '22' },
    { id: 25, name: 'Tommy Pham', position: 'Outfielder', number: '28' },
    { id: 26, name: 'Bryan Reynolds', position: 'Outfielder', number: '10' },
    { id: 27, name: 'Ji Hwan Bae', position: 'Outfielder', number: '3' },
    { id: 28, name: 'Jack Suwinski', position: 'Outfielder', number: '65' },
  ];
