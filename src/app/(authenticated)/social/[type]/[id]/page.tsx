...
export default function ChatPage({ params }: ChatProps) {
  ...
  const [activeTab, setActiveTab] = useState<'messages' | 'bets'>('messages');
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white">
      {/* Header - Fixed at top */}
      <div className="fixed top-0 left-0 right-0 border-b border-gray-800 bg-gray-900 z-10">
        ...
        <div className="flex border-b border-gray-800">
          <button
            ...
            className={`flex-1 py-4 px-4 text-center ${
              activeTab === 'messages' ? 'text-white border-b-2 border-white' : 'text-gray-400'
            }`}
          >
            Messages
          </button>
          <button
            ...
            className={`flex-1 py-4 px-4 text-center ${
              activeTab === 'bets' ? 'text-white border-b-2 border-white' : 'text-gray-400'
            }`}
          >
            Bets
          </button>
      ...
      {/* Content Area */}
      <div className="flex-1 overflow-y-auto mt-[120px] mb-[72px]">
        {activeTab === 'messages' ? (
